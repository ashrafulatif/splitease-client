import MemberView from "@/components/module/Manager/MemberComponents/MemberView";
import { Metadata } from "next";
import { getHouseMembersAction } from "./_action";
import { getMyHouseAction } from "../house/_action";

const MembersPage = async ({ searchParams }: {searchParams: Promise<{ house?: string }>}) => {
  ...
  return (
    <div className="p-4 md:p-6 md:max-w-6xl mx-auto w-full">
      <MemberView members={members} houses={houses} selectedHouseId={selectedHouseId} />
    </div>
  );
};
